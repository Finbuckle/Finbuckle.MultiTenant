...
namespace Finbuckle.MultiTenant
{
    ...
    /// </summary>
    public static class FinbuckleTenantSessionExtensions
    {
        /// <summary>
        /// Returns the current IMultiTenantContext or null if there is none.
        /// </summary>
        public static IMultiTenantContext GetMultiTenantContext(this TenantSession tenantSession)
        {
            object multiTenantContext = null;
            tenantSession.TryGetValue(Constants.HttpContextMultiTenantContext, out multiTenantContext);
