...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class FinbuckleMultiTenantServiceCollectionExtensions
    {
        ...
        public static FinbuckleMultiTenantBuilder AddBlazorMultiTenant(this IServiceCollection services)
        {
            services.AddHttpContextAccessor();
            services.TryAddScoped<TenantInfo>(sp => sp.GetRequiredService<TenantSession>().GetMultiTenantContext()?.TenantInfo);
            ...
            services.TryAddSingleton<IMultiTenantContextAccessor, BlazorMultiTenantContextAccessor>();

            services.TryAddSingleton<TenantSession>();
