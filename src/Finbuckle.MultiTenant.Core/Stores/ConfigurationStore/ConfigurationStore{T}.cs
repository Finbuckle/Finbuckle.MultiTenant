...
{
    public class ConfigurationStore<T> : IMultiTenantStore where T: TenantInfo
    {
        internal const string defaultSectionName = "Finbuckle:MultiTenant:Stores:ConfigurationStore";
        private readonly IConfigurationSection section;
        private ConcurrentDictionary<string, T> tenantMap;
        ...
        private void UpdateTenantMap()
        {
            ...
            {
                var newTenant = section.GetSection("Defaults").Get<T>(options => options.BindNonPublicProperties = true);
