...
namespace Finbuckle.MultiTenant.MassTransit.MassTransitFilters
{
    ...
    /// </code>
    /// </example>
    public class TenantExecuteFilter<T> : IFilter<ExecuteContext<T>> 
        where T : class
    {
        ...
        public TenantExecuteFilter(ITenantResolver tenantResolver, IMultiTenantContextSetter mtcSetter)
        {
