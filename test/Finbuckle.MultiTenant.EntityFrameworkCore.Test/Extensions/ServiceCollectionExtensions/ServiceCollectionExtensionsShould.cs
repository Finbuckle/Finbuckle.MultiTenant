...
public class ServiceCollectionExtensionsShould
{
    ...
    /// <summary>
    /// Regression test: AddMultiTenantDbContext must set TenantInfo from the ambient
    /// ITenantContext even when the DbContext does NOT inherit from
...
/// A DbContext that implements IMultiTenantDbContext directly, WITHOUT inheriting from
    /// MultiTenantDbContext and WITHOUT constructor-injecting ITenantContext.
