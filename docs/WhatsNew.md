# What's New in v<span class="_version">10.1.1</span>

> This page only lists release update details specific to v<span class="_version">10.1.1</span>. [Release update details for all releases are shown in the history page.](History)
