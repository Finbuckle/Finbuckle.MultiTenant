# What's New in v<span class="_version">9.2.0</span>

> This page only lists release update details specific to v<span class="_version">9.2.0</span>. [Release update details for all releases are shown in the history page.](History)
